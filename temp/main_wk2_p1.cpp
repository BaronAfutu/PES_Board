...
int main() {
  ...
  // minimal pulse width and maximal pulse width obtained from the servo
  // calibration process
  // reely S0090
  ...
  while (true) {
    ...
    if (do_execute_main_task) {
      ...
      servo_D2.setPulseWidth(servo_input);
      ...
      if ((servo_input < 1.0f) && // constrain servo_input to be < 1.0f
        ...
        // servo_input += 0.005f;
        servo_input += 0.25f; // after calibration to test that 4 turns take it to 180
      servo_counter++;
    } else {
